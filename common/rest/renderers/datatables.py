...
class DatatablesRenderer(JSONRenderer):
    ...
    @staticmethod
    def _filter_unused_fields(request, result, force_serialize):
    ...
    @staticmethod
    def _filter_extra_json(view, result, extra_json_funcs):
        read_only_keys = result.keys()
