"use strict";
const DailyChart1 = function (src) {
    const the = this;
...
"use strict";
const MonthlyChart2 = function (src) {
    const the = this;
    if (!document.getElementById(src)) {
        return;
    }
...
const MonthlyChart3 = function (src) {
    const the = this;
    if (!document.getElementById(src)) {
        return;
    }
...
const MonthlyChart = function (src) {
    ...
    const Plugin = {
        set: function (label, data, color) {
            if (!Array.isArray(data)) {
                console.error("'data' parameter of MonthlyChart.set() is only allowed array type.");
            }
...
const DailyChart = function (src) {
    ...
    const Plugin = {
        set: function (dataset) {
            if (!Array.isArray(dataset)) {
                console.error("'dataset' parameter of DailyChart.set() is only allowed array type.");
            }
